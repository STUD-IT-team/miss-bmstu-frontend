    ...
    <ul class="partners-descriptions-container">
      <li v-for="(partner, idx) in partnersList" :ref="`anchor-${idx}`" class="partner-container">
        ...
        <div class="info-container">
          ...
          <div class="description" v-html="'<style> mark {background: none; color: #60bbf4;} p {margin: 1em 0; line-height: 1.5;} listing {display: block; font-family: monospace; white-space: pre; margin: 1em 0;}</style>' + partner.description"></div>
        </div>
      </li>
    </ul>
  </div>
