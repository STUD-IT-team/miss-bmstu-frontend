...
<template>
  <div class="root-page-final">
    <header class="header">РЕЗУЛЬТАТЫ КОНКУРСА<br>«МИСС ОЧАРОВАНИЕ – 2026»</header>

    <section class="main-text">
      <p><mark>24&nbsp;апреля</mark> в&nbsp;Большом зале Центра креативных индустрий прошел финал конкурса<br><mark>«МиСС Очарование  — 2026».</mark></p>
