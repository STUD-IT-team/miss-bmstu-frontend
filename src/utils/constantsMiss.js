...
export const partnersList = [
  ...
  //   logo: ImagePartner2,
  //   title: 'Hobby Games',
  //   description: '<p>Хочешь окунуться в мир тайных кланов, ночных схваток и эпичных приключений?</p><p>«Hobby Games» — проводник в мир настолок! Это крутой интернет-магазин и сеть розничных магазинов по всей России, где ты найдёшь игры на любой вкус: от хитрых стратегий до безумно весёлых party-геймов.</p><p>Здесь ты прокачаешь навыки скрытности, тактики и, конечно, зарядишься адреналином и эмоциями! Заходи, выбирай игру — и пусть победит хитрейший!</p><p>Hobby Games — играй с лучшими!</p>',
  //   href: 'https://hobbygames.ru/',
  // },
  // {
  //   logo: ImagePartner3,
  //   title: 'Adelfi Beauty Studio',
  //   description: '<p>Adelfi Beauty Studio — место, где красота становится искусством, а забота о клиентах — главный приоритет. Здесь предлагается широкий спектр услуг: лазерная эпиляция, косметология, массаж, маникюр и педикюр, уход за бровями и ресницами. Процедуры проводят опытные специалисты с использованием высококачественных материалов.</p><p>Adelfi Beauty Studio — место, где красота не требует жертв!</p>',
  //   href: 'https://adelfi-studio.ru',
  // },
  // {
  //   logo: ImagePartner4,
  //   title: 'Автошкола РЕАЛ',
  //   description: '<p>Автошкола РЕАЛ — это успешная сеть современных автошкол, которая поднимает уровень получения водительского удостоверения на новый уровень. Здесь собрали всё лучшее для учеников:</p><ul class="listing"><li>— профессиональные преподаватели</li><li>— опытные инструкторы</li><li>— сопровождение на каждом этапе обучения</li><li>— собственное приложение для обучения в онлайн-формате</li><li>— множество филиалов в Москве и Московской области</li></ul>',
