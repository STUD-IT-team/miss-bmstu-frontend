...
export const partnersList = [
  ...
  //   description: '<p>Управление молодёжной политики — одно из ключевых подразделений МГТУ им. Н.Э. Баумана, играющее важную роль в развитии студенческой среды в нашем Университете. В его структуре действуют отделы, способствующие реализации творческих и социальных инициатив. Управление проводит анализ потребностей молодёжи, создаёт программы поддержки для их реализации, формирует условия для активного участия молодёжи в жизни Университета и поддерживает талантливых и перспективных студентов.</p> <p>«Лидеры управляют будущим — мы создаём лидеров!»</p>',
