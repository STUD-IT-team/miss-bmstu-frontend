...
export const missList = [
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Великие дела никогда не рождаются в одиночестве. Они рождаются в сердце того, кто осмелился поверить, и в руках тех, кто осмелился поддержать!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '«Как ложкой, так и шашкой» — цитата донских казаков',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Каждое мгновение радости и печали, каждое тёплое объятие и слово поддержки создают нашу жизнь и находят свое отражение в семье.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Многие люди терпят неудачу только потому, что сдаются в двух шагах от успеха.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Можно сколько угодно подбадривать человека с завязанными глазами — пусть смотрит сквозь платок, всё равно он ничего не увидит. Только когда снимут платок, он увидит всё. Помощь — вот что нужно человеку, а вовсе не подбадривание.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Милосердие — это не слабость, а великая сила, способная исцелять и поднимать даже тогда, когда всё вокруг рушится.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Истинная свобода — это мужество оставаться верным себе, даже когда мир вокруг требует обратного.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Настоящая ценность жизни — в свете, который мы зажигаем внутри себя и передаём другим.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Каждому поколению свойственно считать себя призванным переделать мир.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Русский народ есть особенный народ в целом свете, который отличается догадкою, умом, силою.',
      },
    ]
  },
];
