...
export const missList = [
  ...
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Историческая память</mark> — это связь поколений, наши корни и духовная основа. Я бережно храню прошлое вольного Дона и помню казачек, чья сила заключалась в сочетании мягкости и стойкости, заботы и отваги!\n\n«Как ложкой, так и шашкой»\nКазачья поговорка',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Семья</mark> — моя опора, вдохновение и источник силы. В её тепле рождается радость, а преодолевать трудности становится проще. Крепкие семейные узы — основа счастья и роста!\n\n«Каждое мгновение радости и печали, каждое тёплое объятие и слово поддержки создают нашу жизнь и находят своё отражение в семье»\nЯна Адриановская',
      },
    ]
  },
  {
  ...
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Взаимопомощь и взаимоуважение</mark> — основа моего мировоззрения. Я верю, что открытость миру и искренняя забота о людях создают новые возможности. Именно эти простые, но важные ценности делают жизнь лучше.\n\n«Можешь сколько угодно подбадривать человека с завязанными глазами — пусть смотрит сквозь платок, всё равно он ничего не увидит, и, только когда снимут платок, он увидит всё.»\nФранц Кафка',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Милосердие</mark> — это сила, живущая в каждом. Когда глаза моих учеников загораются от маленьких побед, я понимаю: доброе слово и поддержка творят чудеса. <mark>Милосердие</mark> наполняет жизнь смыслом и заставляет верить в лучшее!\n\n«Милосердие — это не слабость, а великая сила, способная исцелять и поднимать даже тогда, когда всё вокруг рушится!»\nСофия Сутковая',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Труд</mark> закаляет характер, дисциплинирует и ведёт к цели. Он дарит уверенность и радость от достижений, но важно помнить о балансе: без отдыха не будет сил двигаться вперёд!\n\n«Успех — это результат подготовки, тяжелой работы и обучения на ошибках.»\nКолин Пауэлл',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style><mark>Жизнь</mark> научила меня не только идти вперёд, но и сохранять веру, помогая другим. Благодаря падениям и подъёмам я поняла: даже в темноте можно найти свет. В этом и заключается главная ценность <mark>жизни</mark>!\n\n«Настоящая ценность жизни — в свете, который мы зажигаем внутри себя и передаём другим.»\nЕкатерина Ковалева',
      },
    ]
  },
  {
  ...
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<style>mark {background: none;color: #0066ff;}</style>Нет ничего сильнее любви к Родине — месту, что дарит жизнь, силы и вдохновение. Искренний <mark>патриотизм</mark> наполняет гордостью за родную землю и людей, делая нас духовно крепче. В нём — наша связь с прошлым и вера в будущее!\n\n«Русский народ есть особенный народ в целом свете, который отличается от других: догадкою, умом, силою.»\nЕкатерина II',
      },
    ]
  },
];
