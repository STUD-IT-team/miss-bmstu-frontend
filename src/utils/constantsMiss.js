...
export const missList = [
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Коллективизм</strong>\n\nВеликие дела никогда не рождаются в одиночестве. Они рождаются в сердце того, кто осмелился поверить, и в руках тех, кто осмелился поддержать!\n\nМоя суперспособность — объединять людей. Как дерево в лесу, я сильнее, когда меня окружают другие. Я выросла в семье, где побеждали вместе, и теперь знаю: даже самая яркая искра в одиночестве не станет пламенем!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Историческая память\n\n«Как ложкой, так и шашкой» — цитата донских казаков\n\nИсторическая память — это связь поколений, наши корни и духовная основа. Я бережно храню прошлое вольного Дона и помню казачек, чья сила заключалась в сочетании мягкости и стойкости, заботы и отваги!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Семья\n\nКаждое мгновение радости и печали, каждое тёплое объятие и слово поддержки создают нашу жизнь и находят свое отражение в семье.\n\nСемья — моя опора, вдохновение и источник сил. В её тепле рождается радость, а преодоление трудностей становится проще. Крепкие семейные узы — основа счастья и роста!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Единство народов России\n\nМногие люди терпят неудачу только потому, что сдаются в двух шагах от успеха.\n\nНа протяжении жизни танец открывает мне культуру разных народов, а путешествия дарят верных друзей. Их поддержка вдохновляет идти к цели шаг за шагом — в этом моя сила!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Взаимопомощь и взаимоуважение\n\nМожно сколько угодно подбадривать человека с завязанными глазами — пусть смотрит сквозь платок, всё равно он ничего не увидит. Только когда снимут платок, он увидит всё. Помощь — вот что нужно человеку, а вовсе не подбадривание.\n\nВзаимопомощь и уважение — основа моего мировоззрения. Я верю: открытость миру и искренняя забота о людях создают новые возможности. Именно такие простые, но важные ценности делают жизнь лучше.',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Милосердие\n\nМилосердие — это не слабость, а великая сила, способная исцелять и поднимать даже тогда, когда всё вокруг рушится.\n\nМилосердие — это сила, живущая в каждом. Когда глаза моих учеников загораются от маленьких побед, я вижу: доброе слово и поддержка творят чудеса. Оно наполняет жизнь смыслом и вдохновляет верить в лучшее!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Труд\n\nУспех – это результат подготовки, усердного труда и умения учиться на своих ошибках.\n\nТруд закаляет характер, дисциплинирует и ведёт к цели. Он дарит уверенность и радость от достижений, но важно помнить о балансе — без отдыха не будет сил идти вперёд!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Жизнь\n\nНастоящая ценность жизни — в свете, который мы зажигаем внутри себя и передаём другим.\n\nЖизнь научила меня не только идти вперёд, но и сохранять веру, помогая другим. Благодаря падениям и подъёмам я поняла: даже в темноте можно найти свет. Это и есть её главная ценность!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Преемственность поколений\n\nКаждому поколению свойственно считать себя призванным переделать мир!\n\nПреемственность поколений — это не просто связь времён, а живая река, где мудрость прошлого встречается с дерзостью будущего. Быть её частью — значит с благодарностью принимать наследие предков и смело передавать его дальше. В этом единстве памяти и мечты рождается настоящее!',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Патриотизм\n\nРусский народ есть особенный народ в целом свете, который отличается догадкою, умом, силою.\n\nНет ничего сильнее любви к Родине — месту, что дарит жизнь, силы и вдохновение. Это чувство наполняет гордостью за родную землю и людей, делая нас духовно крепче. В нём — наша связь с прошлым и вера в будущее!',
      },
    ]
  },
];
