...
export const missList = [
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Моя суперспособность — объединять людей. Как дерево в лесу, я сильнее, когда меня окружают другие. Я выросла в семье, где побеждали вместе, и именно там я поняла, что <strong>коллективизм</strong> делает нас сильнее. Теперь я знаю: даже самая яркая искра в одиночестве не станет пламенем!\n\n«Великие дела никогда не совершаются в одиночестве. Они зарождаются в сердце того, кто осмелился поверить, и воплощаются в руках тех, кто осмелился поддержать!»\nЕлизавета Терехова',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Историческая память</strong> — это связь поколений, наши корни и духовная основа. Я бережно храню прошлое вольного Дона и помню казачек, чья сила заключалась в сочетании мягкости и стойкости, заботы и отваги!\n\n«Как ложкой, так и шашкой»\nКазачья поговорка',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Семья</strong> — моя опора, вдохновение и источник силы. В её тепле рождается радость, а преодолевать трудности становится проще. Крепкие семейные узы — основа счастья и роста!\n\n«Каждое мгновение радости и печали, каждое тёплое объятие и слово поддержки создают нашу жизнь и находят своё отражение в семье»\nЯна Адриановская',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'На протяжении жизни танец открывает мне культуру разных народов, а путешествия дарят верных друзей. Познавая традиции и обычаи, я ощущаю <strong>единство народов России</strong>, где каждая культура дополняет общую историю. Их поддержка вдохновляет идти к цели шаг за шагом — в этом моя сила!\n\n«Многие люди терпят неудачу только потому, что сдаются в двух шагах от успеха!»\nТомас Эдисон',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Взаимопомощь и взаимоуважение</strong> — основа моего мировоззрения. Я верю, что открытость миру и искренняя забота о людях создают новые возможности. Именно эти простые, но важные ценности делают жизнь лучше.\n\n«Можешь сколько угодно подбадривать человека с завязанными глазами — пусть смотрит сквозь платок, всё равно он ничего не увидит, и, только когда снимут платок, он увидит всё.»\nФранц Кафка',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Милосердие</strong> — это сила, живущая в каждом. Когда глаза моих учеников загораются от маленьких побед, я понимаю: доброе слово и поддержка творят чудеса. <strong>Милосердие</strong> наполняет жизнь смыслом и заставляет верить в лучшее!\n\n«Милосердие — это не слабость, а великая сила, способная исцелять и поднимать даже тогда, когда всё вокруг рушится!»\nСофия Сутковая',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Труд</strong> закаляет характер, дисциплинирует и ведёт к цели. Он дарит уверенность и радость от достижений, но важно помнить о балансе: без отдыха не будет сил двигаться вперёд!\n\n«Успех — это результат подготовки, тяжелой работы и обучения на ошибках.»\nКолин Пауэлл',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Жизнь</strong> научила меня не только идти вперёд, но и сохранять веру, помогая другим. Благодаря падениям и подъёмам я поняла: даже в темноте можно найти свет. В этом и заключается главная ценность <strong>жизни</strong>!\n\n«Настоящая ценность жизни — в свете, который мы зажигаем внутри себя и передаём другим.»\nЕкатерина Ковалева',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: '<strong>Преемственность поколений</strong> — это не просто связь времён, а живая река, в которой мудрость прошлого встречается с дерзостью будущего. Быть её частью — значит с благодарностью принимать наследие предков и смело передавать его дальше. В этом единстве памяти и мечты рождается настоящее!\n\n«Каждому поколению свойственно считать себя призванным переделать мир!»\nАльбер Камю',
      },
    ]
  },
  {
    ...
    QAtexts: [
      {
        question: '',
        answer: 'Нет ничего сильнее любви к Родине — месту, что дарит жизнь, силы и вдохновение. Искренний <strong>патриотизм</strong> наполняет гордостью за родную землю и людей, делая нас духовно крепче. В нём — наша связь с прошлым и вера в будущее!\n\n«Русский народ есть особенный народ в целом свете, который отличается от других: догадкою, умом, силою.»\nЕкатерина II',
      },
    ]
  },
];
